...
export async function generateMetadata({
  ...
  return {
    title: isKk
      ? 'Жасанды интеллектпен фото өңдеу | Шежіре'
      : 'AI фото трансформация — Нейросеть | Шежіре',
    description: isKk
      ? 'AI нейросеть фото трансформация: экшн-фигурка жасау, питомецті адамға айналдыру, Гибли стилі, 100 жыл бұрынғы сурет, бабаңды жасарту. 990 ₸-дан бастап.'
      : 'Обработка фото нейросетью онлайн: экшн-фигурка из фото, питомец в человека, стиль Гибли, фото 100 лет назад, омоложение предка. От 990 ₸.',
    keywords: isKk
    ...
    openGraph: {
      ...
      description: isKk
        ? 'AI фото трансформация: экшн-фигурка, питомец, Гибли, ретро. 990 ₸-дан.'
        : 'AI фото трансформация: экшн-фигурка, питомец, Гибли, ретро. От 990 ₸.',
      url,
      siteName: 'Шежіре',
    ...
    <>
      ...
      <section className="ai-landing-hero">
        <div className="ai-landing-hero-content">
          ...
          />
          <h1>{isKk ? 'AI фото трансформация — 990 ₸-дан' : 'AI фото трансформация — от 990 ₸'}</h1>
          <p className="ai-landing-hero-sub">
            {isKk
              ? 'Жасанды интеллект арқылы суретіңізді трансформациялаңыз — 990 ₸-дан бастап'
              : 'Трансформируйте фото с помощью AI — от 990 ₸ за пакет'}
          </p>
        </div>
      </section>
          ...
          {isKk ? (
            <>
              ...
              <p>
                ...
                Телефон нөміріңізбен тіркеліңіз және AI-фото жасауды 990 ₸-дан бастаңыз!
              </p>
              ...
              <ul>
                <li><strong>990 ₸-дан</strong> — Starter: 5 генерация, жылдам бастау</li>
            ...
            <>
              ...
              <p>
                ...
                Зарегистрируйтесь по номеру телефона и начните создавать AI-фото от 990 ₸!
              </p>
              ...
              <p>
                ...
                нейросетью по фото — новый тренд. Зарегистрируйтесь и создавайте AI-фото от 990 ₸.
              </p>
              ...
              <p>
                ...
                культура — стиль Гибли фото. Регистрация по номеру телефона, от 990 ₸.
              </p>

              <h3>Почему Шежіре AI?</h3>
              <ul>
                <li><strong>От 990 ₸</strong> — Starter: 5 генераций, быстрый старт</li>
