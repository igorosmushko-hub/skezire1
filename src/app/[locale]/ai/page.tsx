...
export async function generateMetadata({
  ...
  return {
    title: isKk
      ? 'AI фото трансформация — Нейросеть | Шежіре'
      : 'AI фото трансформация — Нейросеть | Шежіре',
    description: isKk
      ? 'AI нейросеть фото трансформация: экшн-фигурка жасау, питомецті адамға айналдыру, Гибли стилі, 100 жыл бұрынғы сурет, бабаңды жасарту. Тіркелгеннен кейін 3 тегін генерация.'
      : 'Обработка фото нейросетью онлайн: экшн-фигурка из фото, питомец в человека, стиль Гибли, фото 100 лет назад, омоложение предка. 3 бесплатные генерации после регистрации.',
    keywords: isKk
      ? 'AI фото, нейросеть фото, экшн-фигурка, питомец адамға, Гибли стилі, фото трансформация, ретро фото, шежіре'
      : 'нейросеть фото, AI фото онлайн, экшн-фигурка из фото, питомец в человека, стиль Гибли, фото 100 лет назад, омоложение фото нейросеть, шежіре',
    openGraph: {
      type: 'website',
      title: isKk ? 'AI Мүмкіндіктері | Шежіре' : 'AI Функции | Шежіре',
      description: isKk
        ? 'AI фото трансформация: экшн-фигурка, питомец, Гибли, ретро. 3 тегін генерация.'
        : 'AI фото трансформация: экшн-фигурка, питомец, Гибли, ретро. 3 бесплатные генерации.',
      url,
      siteName: 'Шежіре',
    ...
    <>
      ...
      <section className="ai-landing-hero">
        <div className="ai-landing-hero-content">
          ...
          />
          <h1>{isKk ? 'AI фото трансформация — 3 тегін генерация' : 'AI фото трансформация — 3 бесплатные генерации'}</h1>
          <p className="ai-landing-hero-sub">
            {isKk
              ? 'Жасанды интеллект арқылы суретіңізді трансформациялаңыз — тіркеліңіз, 3 тегін генерация алыңыз'
              : 'Трансформируйте фото с помощью AI — зарегистрируйтесь и получите 3 бесплатные генерации'}
          </p>
        </div>
      </section>
      ...
      <section className="ai-seo-section">
        <div className="container">
          {isKk ? (
            <>
              <h2>AI нейросеть арқылы фото трансформация</h2>
              <p>
                ...
                Телефон нөміріңізбен тіркеліңіз — 3 тегін генерация аласыз!
              </p>
              ...
              <ul>
                <li><strong>3 тегін генерация</strong> — телефон нөміріңізбен тіркеліңіз</li>
            ...
            <>
              <h2>AI фото трансформация нейросетью</h2>
              <p>
                ...
                Зарегистрируйтесь по номеру телефона и получите 3 бесплатные генерации!
              </p>
              ...
              <p>
                ...
                нейросетью по фото — новый тренд. Зарегистрируйтесь и получите 3 бесплатные генерации.
              </p>
              ...
              <p>
                ...
                культура — стиль Гибли фото. Регистрация по номеру телефона, 3 генерации бесплатно.
              </p>

              <h3>Почему Шежіре AI?</h3>
              <ul>
                <li><strong>3 бесплатные генерации</strong> — зарегистрируйтесь по номеру телефона</li>
