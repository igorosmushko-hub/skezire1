...
export async function generateMetadata({
  ...
  return {
    ...
    description: isKk
      ? 'AI фото генерация пакеттері: Starter, Standard, Premium. Экшн-фигурка, Гибли стилі, 100 жыл бұрынғы фото, питомецті адамға айналдыру. 990 ₸-дан бастап.'
      : 'Пакеты AI фото-генераций: Starter, Standard, Premium. Экшн-фигурка, стиль Гибли, фото 100 лет назад, питомец в человека. От 990 ₸.',
    keywords: isKk
    ...
    openGraph: {
      ...
      description: isKk
        ? 'Ақылы пакеттер: 990 ₸-дан. Экшн-фигурка, Гибли, 100 жыл бұрынғы фото.'
        : 'Платные пакеты от 990 ₸. Экшн-фигурка, Гибли, фото 100 лет назад.',
      url,
      siteName: 'Шежіре',
    ...
    <>
      ...
      <section style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <ul style={{ lineHeight: 1.8, color: '#444', paddingLeft: 20 }}>
          <li>{isKk ? 'Starter: 5 генерация — 990 ₸' : 'Starter: 5 генераций — 990 ₸'}</li>
