...
export async function generateMetadata({
  ...
  return {
    ...
    description: isKk
      ? 'Шежіре — қазақ ата-тегінің онлайн ағашы. Жеті атаңызды біліңіз, руыңызды анықтаңыз, шежіре ағашын жасаңыз. AI фото трансформация — 990 ₸-дан. Шежіре постерін холстқа басып алыңыз.'
      : 'Шежіре — казахское генеалогическое дерево онлайн. Узнайте свой род, жуз и семь поколений предков. Создайте шежіре дерево. AI фото трансформация — от 990 ₸. Закажите постер на холсте.',
    keywords: isKk
    ...
    openGraph: {
      ...
      description: isKk
        ? 'Жеті атаңызды біліңіз, руыңызды анықтаңыз. AI фото — 990 ₸-дан. Постер холстқа.'
        : 'Узнайте свой род и 7 поколений предков. AI фото — от 990 ₸. Постер на холсте.',
      url,
      siteName: 'Шежіре',
