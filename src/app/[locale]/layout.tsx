...
export async function generateMetadata({
  ...
  return {
    ...
    description: isKk
      ? 'Шежіре — қазақ ата-тегінің онлайн ағашы. Жеті атаңызды біліңіз, руыңызды анықтаңыз. AI фото: 100 жыл бұрынғы сурет, Гибли стилі, экшн-фигурка — 990 ₸-дан.'
      : 'Шежіре — казахское генеалогическое дерево онлайн. Узнайте свой род, жуз и семь поколений предков. AI фото: 100 лет назад, стиль Гибли, экшн-фигурка — от 990 ₸.',
    keywords: isKk
    ...
    openGraph: {
      ...
      description: isKk
        ? 'Жеті атаңызды біліңіз, руыңызды анықтаңыз. AI фото — 990 ₸-дан.'
        : 'Узнайте свой род и семь поколений предков. AI фото — от 990 ₸.',
      url,
      siteName: 'Шежіре',
    ...
    twitter: {
      ...
      title: isKk ? 'Шежіре — Қазақша шежіре ағашы' : 'Шежіре — Казахское генеалогическое дерево',
      description: isKk
        ? 'Қазақ ата-тегінің онлайн ағашы + AI фото — 990 ₸-дан.'
        : 'Казахское генеалогическое дерево + AI фото — от 990 ₸.',
      images: [ogImage],
    },
    alternates: {
      canonical: url,
